...
export default class CountryDropdown extends Component {
	...
	constructor (props) {
	 ...
	 getCountries = () =>{
		...
		return this.state.countries.map((countryObj) => (
            
			<MenuItem value={(valueType === C.DISPLAY_TYPE_SHORT) ? countryObj.countryShortCode : countryObj.countryName} key={countryObj.countryShortCode}>
				{(labelType === C.DISPLAY_TYPE_SHORT) ? countryObj.countryShortCode : countryObj.countryName}
			</MenuItem>
		));
	}
